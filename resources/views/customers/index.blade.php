...
<center><h1> DATA CUSTOMER </h1></center>
	...
	@role('Administrator'){{-- 
	<a href="deleteAll" class="btn btn-danger"><i class="glyphicon glyphicon-trash"> Delete All </i></a> --}}
	@endrole
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<div class="panel-body">
			<table class="table" id="example">
                ...
                <li class="dropdown">
                    ...
                    <center><a class="btn btn-primary" data-toggle="modal" data-target="#myModal{{$data->id}}"><i class="glyphicon glyphicon-edit"> Edit </i></a>
                   	<form action="{{route('customers.destroy',$data->id)}}" method="post" class ="delete"><br>
		    ...
		    <div class="input-group">
				...
				<input type="text" value="{{$data->nama_customer}}" name="a" class="form-control" required="">
			</div>
			<br>
